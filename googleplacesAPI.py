...
conn4 = pyodbc.connect("DRIVER={NetezzaSQL};SERVER=;PORT=;DATABASE=PRD_WHSE;UID=;PWD=;")
curs4 = conn4.cursor()
conn5 = pyodbc.connect("DRIVER={NetezzaSQL};SERVER=;PORT=;DATABASE=SANDBOX;UID=;PWD=;")
curs5 = conn5.cursor()
